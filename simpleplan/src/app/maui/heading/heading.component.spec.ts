...
describe('Heading', () => {
    ...
    it ('should not display subheading', () => {
        const headingText = 'heading content';
        comp.heading = headingText;
        comp.subheading = undefined;
        fixture.detectChanges();

        const heading = fixture.nativeElement.querySelector('.maui-heading__main');
        const subheading = fixture.nativeElement.querySelector('.maui-heading__sub');
