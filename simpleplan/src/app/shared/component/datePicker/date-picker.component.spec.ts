...
function getElements(id: string): DebugElement[] {
...
xdescribe('DatePickerComponent', () => {
    beforeEach(() => {
        ...
        de = fixture.debugElement.query(By.css('.agl-omm-date-picker'));
        el = de.nativeElement;
    });
    ...
    it('test calendar year 2016 month one by one - next month button', () => {
        ...
        let beginDate: string[] = ['28', '1', '29', '28', '25', '30', '27', '1', '29', '26', '31', '28'];
        let endDate: string[] = ['7', '13', '10', '8', '5', '10', '7', '11', '9', '6', '11', '8'];
    ...
    it('options - dayLabels', () => {
        ...
        for (let i in ths) {
            if (i) {
                let elm = ths[i];
                expect(parseInt(elm.nativeElement.textContent, 10)).toBe(parseInt(i, 10) + 1);
            }
        }
    });
    ...
    it('options - monthLabels', () => {
        ...
        for (let i = 1; i <= 12; i++) {
            ...
            expect(parseInt(monthLabel.nativeElement.textContent, 10)).toBe(i);
            nextmonth.nativeElement.click();
        }
    });
